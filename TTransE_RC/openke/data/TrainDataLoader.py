...
class TrainDataLoader(object):
	...
	def read(self):
		...
		self.batch_temp = np.zeros(self.batch_seq_size, dtype=np.int64)
		self.batch_y = np.zeros(self.batch_seq_size, dtype=np.float32)
		self.batch_h_addr = self.batch_h.__array_interface__["data"][0]
		self.batch_t_addr = self.batch_t.__array_interface__["data"][0]
		self.batch_r_addr = self.batch_r.__array_interface__["data"][0]
		self.batch_temp_addr = self.batch_temp.__array_interface__["data"][0]
	...
	def sampling_head(self):
		...
		return {
			...
			"batch_temp": self.batch_temp[:self.batch_size],
			"batch_y": self.batch_y,
			"mode": "head_batch"
		}
