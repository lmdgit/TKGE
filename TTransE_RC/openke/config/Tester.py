...
class Tester(object):
    ...
    def __init__(self, model = None, data_loader = None, use_gpu = True):
        ...
        self.lib.loadfeature1.argtypes = [ctypes.c_int64, ctypes.c_int64, ctypes.c_int64]
        self.lib.loadfeature3.argtypes = [ctypes.c_int64, ctypes.c_int64, ctypes.c_int64, ctypes.c_int64]
    ...
    def test_one_step(self, data):  
        ...
        return self.model.predict({
            ...
            'batch_temp': self.to_var(data['batch_temp'], self.use_gpu),
            'mode': data['mode']
        })

    def run_link_prediction(self, type_constrain = False):
        #self.loadfeature1(self.ent_s, self.r2r_s, self.r2r_o)
        self.lib.initTest()
